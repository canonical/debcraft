.. meta::
  :description: An explanation of the documentation system, process, and writing style and conventions in Debcraft.
...
The documentation is an essential part of Debcraft. We make documentation a disciplined
...
Debcraft practices docs-as-code. The document source files are written in
reStructuredText markup and kept inside the Debcraft source code. Like the rest of the
...
The Debcraft maintainers try and review every PR in a timely manner, typically within a
...
There is no single way to write, but there are guidelines and patterns that Debcraft
documents follow:
