...
def fake_project_service_class(
    ...
    class FakeProjectService(debcraft.services.project.Project):
        @override
        def _load_raw_project(self) -> dict[str, Any]:  # ty: ignore[override-of-final-method]
        ...
        def set(self, value: models.Project) -> None:
            ...
            self._build_for = value.platforms[self._platform].build_for[0]  # ty: ignore[not-subscriptable]
