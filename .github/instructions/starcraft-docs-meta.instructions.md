...
**Do** write the meta description _after_ the page is written. The meta description is a reflection of what's actually on the page.
...
**Do** frame sentences in terms of _actions_ and _facts_.
...
**Don't** include qualities or claims like _simple_, _easy_, or _best-in-class_.

**Don't** include key terms that aren't on the page.

**Don't** use pronouns such as _you_, _your_, _we_, or _our_. These waste space and don't match the tone of a description.

## Example

This is an example of a good meta description for _Set up Starcraft_.
